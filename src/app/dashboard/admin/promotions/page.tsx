  ...
  const loadDiscounts = async () => {
    try {
      ...
      if (response.ok && data.success) {
        ...
        // Debug: Log the first discount to see date format
        if (discounts.length > 0) {
          console.log('Sample discount dates:', {
            startDate: discounts[0].startDate,
            endDate: discounts[0].endDate,
            startDateType: typeof discounts[0].startDate,
            endDateType: typeof discounts[0].endDate
          });
        }
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage discounts and coupon codes</p>
          </div>
          {activeTab === 'discounts' && (
