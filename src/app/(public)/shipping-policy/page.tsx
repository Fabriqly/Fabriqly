...
export const metadata: Metadata = {
  title: 'Shipping Policy | Fabriqly',
  description: 'Learn about Fabriqly\'s shipping methods, delivery times, and shipping costs for your orders.'
};

export const revalidate = 3600; // Revalidate every hour (ISR)

export default async function ShippingPolicyPage() {
  const policy = await policyService.getActivePolicy(PolicyType.SHIPPING);
