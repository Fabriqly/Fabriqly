...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Fabriqly',
  description: 'Read Fabriqly\'s Terms & Conditions. Understand your rights and responsibilities when using our platform.'
};

export const revalidate = 3600; // Revalidate every hour (ISR)

export default async function TermsAndConditionsPage() {
  const policy = await policyService.getActivePolicy(PolicyType.TERMS);
