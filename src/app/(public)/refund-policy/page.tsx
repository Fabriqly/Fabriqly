...
export const metadata: Metadata = {
  title: 'Refund Policy | Fabriqly',
  description: 'Understand Fabriqly\'s refund policy, including eligibility criteria, escrow refund process, and cancellation policies.'
};

export const revalidate = 3600; // Revalidate every hour (ISR)

export default async function RefundPolicyPage() {
  const policy = await policyService.getActivePolicy(PolicyType.REFUND);
