...
interface DesignerAppealFormProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export default function DesignerAppealForm({ 
  isOpen, 
  onClose, 
  onSuccess, 
  suspensionReason 
}: DesignerAppealFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/designer-appeal', {
        method: 'POST',
        headers: {
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Request review of your account suspension</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Please explain why you believe your account should be restored. Include any relevant information that may help with the review process..."
                rows={6}
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            ...
            <ol className="text-sm text-gray-600 space-y-1">
              ...
              <li>4. If approved, your account will be restored and you can continue using the platform</li>
            </ol>
          </div>
        </div>
      </div>
